    ...
    <div className="container-fluid p-0">
      ...
      >
        <div className="w-100">
          ...
          <br/>
           Experienced with a wide range of frontend & backend technologies,<br/> specialized on native ios and android development.
          </p>
        ...
        <div className="w-100">
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
            ...
            <h3 className="mb-0">Full Stack & Mobile Developer</h3>
              ...
              <ul>
                ...
                <li>
                  Developed & maintained android (java) - ios (Swift).
                </li>
                <li>
                  Developed & maintained back-end - front-end.
                </li>
              </ul>
            </div>
            <div className="resume-date text-md-right">
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between">
            <div className="resume-content">
              ...
              <div className="subheading mb-3">Digital Media Company / POPS</div>
              <ul>
                <li>
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between">
            <div className="resume-content">
              ...
              <ul>
                  <li>
                    Full Stack development for a mechanical company, using ajax, php & mysql.
                  </li>
                  <li>
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between">
            ...
            <h3 className="mb-0">Junior Frontend & Mobile Developer</h3>
              <div className="subheading mb-3">Digital Media Company / Noollab</div>
              <ul>
        ...
        <div className="w-100">
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
            ...
            <h3 className="mb-0">Self Taught</h3>
              ...
              <div>Frontend - Backend - Native Mobile Development /  IOS - Android</div>
              <p>GPA: 3.23</p>
            </div>
            <div className="resume-date text-md-right">
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between">
            <div className="resume-content">
            <h3 className="mb-0">International High School of Asunción Paraguay</h3>
              <div className="subheading mb-3">Degree in business administration</div>
              <p>GPA: 4.21</p>
            </div>
            <div className="resume-date text-md-right">
      ...
      >
        <div className="w-100">
          ...
          <p>
            Apart from being a developer I love to be with my Family and my dogs,
            <br/>
            play videogames and go out with my friends,
            <br/>
            some weekends I prefer to code small scripts just for fun and
            <br/>
            pentesting websites & apps just for curiosity. Reported some vulnerabilities.
          </p>
      ...
      >
        ...
        <h2 className="mb-5">Awards &amp; Certifications</h2>
          <ul className="fa-ul mb-0">
              <li>
                <a href="https://courses.edx.org/certificates/c032836401624fb8bb961ddc2bbb3c0a" target="_blank" rel="noopener noreferrer">
                  <i className="fa-li fa fa-certificate text-warning"></i>
                  React Router and Redux - Microsoft Certification
                </a>
              </li>
            <li>
              <a href="https://courses.edx.org/certificates/942095c1a18b413fa30cfa273a5d0657" target="_blank" rel="noopener noreferrer">
                <i className="fa-li fa fa-certificate text-warning"></i>
                Data Science With R - HarvardX Certification
              </a>
            </li>
            <li>
              <a href="https://courses.edx.org/certificates/ffbc662f31aa4053a1329069a297f437" target="_blank" rel="noopener noreferrer">
                <i className="fa-li fa fa-certificate text-warning"></i>
                Introduction to ReactJs - Microsoft Certification
              </a>
            </li>
            <li>
              <a href="https://www.testdome.com/cert/aek2kr6z2e" target="_blank" rel="noopener noreferrer">
                <i className="fa-li fa fa-certificate text-warning"></i>
                HTML/CSS, JS and SQL - TestDome Certification
              </a>
            </li>
            <li>
              <a href="https://www.testdome.com/cert/56ttdj7sjj" target="_blank" rel="noopener noreferrer">
                <i className="fa-li fa fa-certificate text-warning"></i>
                Javascript top 10% Score - TestDome Certification
              </a>
            </li>
            <li>
              <a href="https://www.testdome.com/cert/zswuzeb1xc" target="_blank" rel="noopener noreferrer">
                <i className="fa-li fa fa-certificate text-warning"></i>
                PHP - TestDome Certification
              </a>
            </li>
            <li>
              <a href="https://www.testdome.com/cert/unskv5sxcw" target="_blank" rel="noopener noreferrer">
                <i className="fa-li fa fa-certificate text-warning"></i>
