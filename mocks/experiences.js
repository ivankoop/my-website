export const experiences = [
  ...
  {
    description:
      '<ul><li>Worked as a full-stack developer on an Agile remote team, handling multiple projects at once</li><li>Developed front-end features using <a target="_blank" rel="noopener noreferrer" href="https://reactjs.org/">React</a>, back-end services with <a target="_blank" rel="noopener noreferrer" href="https://www.python.org/">Python</a>/<a target="_blank" rel="noopener noreferrer" href="https://www.djangoproject.com/">Django</a>, and mobile applications for <a target="_blank" rel="noopener noreferrer" href="https://www.android.com/">Android</a> and <a target="_blank" rel="noopener noreferrer" href="https://www.apple.com/ios/">iOS</a></li><li>Refactored main modules of a legacy React app to improve performance and maintainability</li><li>Participated in weekly Scrum meetings and communicated daily with product owners, designers, and other developers</li><li>Performed code reviews, wrote API documentation, and conducted front-end and back-end testing</li></ul>',
  ...
  {
    description:
      '<ul><li>Integrated <a target="_blank" rel="noopener noreferrer" href="https://reactjs.org/">ReactJS</a> into a registration form for the MUV App</li><li>Served as a mentor at a coding boot camp for <a target="_blank" rel="noopener noreferrer" href="https://penguin.academy/">Penguin Academy</a>, a Swiss company</li><li>Developed a full-stack e-commerce website using <a target="_blank" rel="noopener noreferrer" href="https://codeigniter.com/">CodeIgniter</a> and <a target="_blank" rel="noopener noreferrer" href="https://reactjs.org/">ReactJS</a>, with <a target="_blank" rel="noopener noreferrer" href="https://expressionengine.com/">Expression Engine</a> as the CMS (Tobiano)</li><li>Integrated credit card purchases for a local e-commerce website (<a target="_blank" rel="noopener noreferrer" href="https://mercadomovil.com.py/">Mercado Movil</a>)</li><li>Developed a full-stack website for a loan company using <a target="_blank" rel="noopener noreferrer" href="https://laravel.com/">Laravel</a></li></ul>',
